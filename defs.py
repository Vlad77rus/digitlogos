...
def info_s():
    inf = ["0","цели", "семья", "стабильность", "самоощенка", "деньги", "талант", "плотские", "духовные"]
    return inf
...
def detinfo (Det, delta : int): # Разьяснение детерминанта и дельты
    inf = ['0', 'наводящий порядок', 'копирующий', 'создающий свой мир', 'ищущий новое', 'революционер', 'бунтарь, разрушитель']
    inf1 = ['0', 'Наблюдение', 'Приспосабливание', 'Преодоление', 'Поиск', 'Преобразование', 'Создание']
